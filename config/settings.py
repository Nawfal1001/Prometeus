...
def reload_from_sources():
    ...
    ATR_TP2_MULT = get_float("ATR_TP2_MULT", 3.0)
    ...
    EXIT_SIGNAL_FLIP_MIN_SCORE = get_float("EXIT_SIGNAL_FLIP_MIN_SCORE", 0.30)
    ...
    PAPER_FORCE_MIN_SCORE = get_float("PAPER_FORCE_MIN_SCORE", 0.15)
