...
def reload_from_sources():
    ...
    global MAX_TRADE_DURATION_BARS, MIN_SESSION_MULT, MIN_ADX, MAX_CONSEC_LOSSES
    ...
    MAX_TRADES_PER_DAY  = get_int("MAX_TRADES_PER_DAY", 8)
    MAX_CONSEC_LOSSES   = get_int("MAX_CONSEC_LOSSES", 7)

    FUSION_THRESHOLD    = get_float("FUSION_THRESHOLD", 0.18)
    MIN_RR_RATIO        = get_float("MIN_RR_RATIO", 1.8)
    ...
    ATR_TP1_MULT     = get_float("ATR_TP1_MULT", 1.5)
    ATR_TP2_MULT     = get_float("ATR_TP2_MULT", 3.5)
    TP1_EXIT_PCT     = get_float("TP1_EXIT_PCT", 0.35)
    TP2_EXIT_PCT     = get_float("TP2_EXIT_PCT", 0.40)
    MAX_TRADE_DURATION_BARS = get_int("MAX_TRADE_DURATION_BARS", 16)
    MIN_SESSION_MULT = get_float("MIN_SESSION_MULT", 0.75)
    MIN_ADX          = get_float("MIN_ADX", 18)
    ...
    BREAKEVEN_BUFFER_PCT = get_float("BREAKEVEN_BUFFER_PCT", 0.0005)
