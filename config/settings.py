...
def reload_from_sources():
    """Reload runtime globals from user_settings.json/.env without restarting."""
    ...
    OPTUNA_TIMEOUT_SEC = get_int("OPTUNA_TIMEOUT_SEC", 300)
    OPTUNA_METRIC = get("OPTUNA_METRIC", "win_rate")
