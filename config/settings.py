...
def reload_from_sources():
    ...
    global NON_CRYPTO_MIN_RR_RATIO
    NON_CRYPTO_FUSION_THRESHOLD = get_float("NON_CRYPTO_FUSION_THRESHOLD", 0.20)
    NON_CRYPTO_MIN_RR_RATIO = get_float("NON_CRYPTO_MIN_RR_RATIO", 2.0)
    ...
    global SCAN_CONCURRENCY
    SCAN_CONCURRENCY = get_int("SCAN_CONCURRENCY", 4)
