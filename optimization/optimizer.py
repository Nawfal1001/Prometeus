...
class PrometheusOptimizer:
    ...
    def _suggest_params(self, trial: optuna.Trial) -> dict:
        ...
        return {
            ...
            "MIN_ADX": trial.suggest_int("MIN_ADX", 12, 30),
            "MIN_ADX_TREND_STRENGTH": trial.suggest_float("MIN_ADX_TREND_STRENGTH", -0.60, 0.20, step=0.05),
            "STRONG_SIGNAL_ADX_BYPASS": trial.suggest_float("STRONG_SIGNAL_ADX_BYPASS", 0.55, 0.90, step=0.05),
