...
class PrometheusOptimizer:
    ...
    def _suggest_params(self, trial: optuna.Trial) -> dict:
        ...
        if "exits" in groups:
            ...
            # Fixed range — dynamic ranges based on sl/tp1 values make the
            # parameter space non-stationary for TPE and destroy convergence.
            # The backtest engine's min-RR gate rejects invalid combinations
            # naturally, so we don't need to enforce them in the suggestion.
    ...
    def _compute_score(self, results: dict) -> float:
        ...
        # Keeping n_sweet at 100 made 30-60 trade configs appear under-valued
        # versus their actual edge, biasing the optimizer toward overtrade configs.
